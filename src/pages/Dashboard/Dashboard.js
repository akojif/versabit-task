...
class Dashboard extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            div style = {
                { flexGrow: 1, flexShrink: 1, maxWidth: 600, justifyContent: 'center' }
            } >
            <
            ...
            <
            div style = {
                { display: 'flex', flexDirection: 'row', alignItems: 'center', margin: 30 }
            } >
            <
            CountUp style = {
                {
