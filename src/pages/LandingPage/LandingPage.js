...
class LandingPage extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            alt = "logo"
            style = {
                { height: 180, maxWidth: 320, color: 'red' }
            }
            />
            ...
            onClick = {
                () => {
                    window.open(
                        'https://github.com/akojif/versabit-task',
                        '_blank'
                    )
                }
            }
            ...
            id = "footer-text" > { `© ${new Date().getFullYear()} Copyright: yourcompany.com! All Rights Reserved` } <
            /AppBar> < /
            div > <
            /React.Fragment> < /
            MuiThemeProvider >
